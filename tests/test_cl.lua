...
must_fail(function() cl.mem.new(1073741825) end)
...
must_fail(function() cl.mem.new(1, -1) end)
must_fail(function() cl.mem.new(1, 1.5) end)
must_fail(function() cl.mem.new(1, true) end)
must_fail(function() cl.mem.from_string(nil) end)
must_fail(function() buffer:fill(0, 0, -1) end)
must_fail(function() buffer:fill(0, 0, 99) end)
must_fail(function() buffer:to_string(0, 99) end)
must_fail(function() buffer:slice(0, 99) end)
must_fail(function() buffer:find("x", -1) end)
must_fail(function() buffer:find("x", 7) end)
must_fail(function() cl.bytes.concat("a", 123) end)
must_fail(function() cl.bytes.from_hex(nil) end)
must_fail(function() cl.bytes.from_hex("0g") end)
must_fail(function() cl.bin.read_u8(123) end)
must_fail(function() cl.bin.read_u8("", -1) end)
must_fail(function() cl.bin.read_f64be("1234567", 0) end)
must_fail(function() cl.bin.f64le(true) end)
must_fail(function() cl.bin.crc32({}) end)
must_fail(function() cl.bits.rol(1, "1") end)
must_fail(function() cl.bits.ror(1, "1") end)
must_fail(function() cl.flags.set(1, "0") end)
must_fail(function() cl.flags.clear(1, -1) end)
