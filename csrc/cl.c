...
static int l_version(lua_State *L) { lua_pushliteral(L, "0.3.0"); return 1; }
...
static const luaL_Reg buffer_methods[] = {
    ...
    {"compare", l_buffer_compare}, {"equals", l_buffer_equals}, {NULL, NULL}
};
...
static const luaL_Reg bits_functions[] = {{"band", l_bits_band}, {"bor", l_bits_bor}, {"bxor", l_bits_bxor}, {"bnot", l_bits_bnot}, {"lshift", l_bits_lshift}, {"rshift", l_bits_rshift}, {"rol", l_bits_rol}, {"ror", l_bits_ror}, {"popcount", l_bits_popcount}, {NULL, NULL}};
